...
@app.post("/communication/peers/discover/geo")
...
@app.get("/communication/dimensions/{dimension_id}")
...
@app.post("/communication/dimensions/register")
...
@app.post("/communication/dimensions/route")
...
@app.get("/communication/connections")
def get_connections():
    if not HAS_COMMUNICATION:
        return {"error": "communication_unavailable"}
